...
const NAV = [
  ...
  { icon: Settings,        label: 'Param̬tres',       href: '/parametres' },
]
  ...
  return (
    <>
      <style>{`
        ...
        .nav-link:hover { background: #f0fdf4 !important; color: #16a34a !important; }
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            {!collapsed && (
              <div>
                ...
                <div style={{
                  fontSize: 9, color: '#16a34a', letterSpacing: '1.8px',
