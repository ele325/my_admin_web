  ...
  return (
    <>
      <style>{`
        ...
        .signup-panel{animation:fadeUp .55s ease both}
        .signup-btn{transition:transform .15s ease,box-shadow .15s ease}
        .signup-btn:hover:not(:disabled){transform:translateY(-1px);box-shadow:0 8px 28px oklch(0.72 0.19 152 / .35)!important}
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 2 }}>
            ...
            <p style={{ color: 'oklch(0.60 0.025 145)', fontSize: 14, lineHeight: 1.72,
              ...
              Créez votre compte et accédez à notre plateforme IoT pour optimiser
              vos ressources agricoles en temps réel.
            </p>
          </div>
          ...
          <div className="signup-panel" style={{ position: 'relative', zIndex: 2, width: '100%', maxWidth: 400 }}>
            <div style={{ marginBottom: 34 }}>
              ...
              <p style={{ color: 'oklch(0.40 0.018 145)', fontSize: 14 }}>
                Rejoignez IrriSmart et gérez vos cultures
              </p>
            </div>
            ...
            <form onSubmit={handleSignup}>
              ...
              <div style={{ marginBottom: 24 }}>
                <label style={{ display: 'block', fontSize: 11, fontWeight: 500,
                  color: 'oklch(0.40 0.018 145)', letterSpacing: '0.6px',
                  textTransform: 'uppercase', marginBottom: 7 }}>Confirmer le mot de passe</label>
                <input
                  className="field-input"
                  type="password" required
                  placeholder="••••••••"
                  ...
                  style={{
                    width: '100%', padding: '13px 14px',
                    background: focused === 'confirm' ? 'oklch(0.72 0.19 152 / .06)' : 'oklch(0.10 0.015 145)',
                    border: confirm && password !== confirm
                      ? '1px solid oklch(0.6 0.22 25)'
                      : focused === 'confirm'
                        ? '1px solid oklch(0.72 0.19 152 / .5)'
                        : '1px solid oklch(0.18 0.013 145)',
                    borderRadius: 11, color: 'oklch(0.96 0.008 145)', fontSize: 14,
                    boxShadow: focused === 'confirm' ? '0 0 0 3px oklch(0.72 0.19 152 / .1)' : 'none',
                  }}
                />
                {confirm && password !== confirm && (
                  <p style={{ fontSize: 12, color: 'oklch(0.6 0.22 25)', marginTop: 6 }}>
            ...
            <p style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: 14, color: 'oklch(0.40 0.018 145)' }}>
              Déjà un compte ?{' '}
              <Link href="/login" style={{ color: 'oklch(0.72 0.19 152)', textDecoration: 'underline' }}>
                Se connecter
              </Link>
            </p>
          </div>
